...
TEST(SpinBox, to_xml) {
  ...
  ASSERT_EQ(string(str.str),
            string("<?xml version='1.0' encoding='UTF-8' standalone='yes' ?>\r\n<spin_box x=\"10\" y=\"20\" w=\"30\" h=\"40\" focusable=\"true\" min=\"0\" max=\"1024\" input_type=\"0\" readonly=\"false\" cancelable=\"false\" auto_fix=\"false\" left_margin=\"2\" right_margin=\"21\" top_margin=\"2\" bottom_margin=\"2\" action_text=\"done\" password_visible=\"false\">\n</spin_box>\n"));
