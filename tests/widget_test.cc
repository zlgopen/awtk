...
TEST(Widget, move_focus) {
  ...
  ASSERT_EQ(widget_move_focus(b1, NULL, NULL, TRUE), RET_OK);
  ASSERT_EQ(b1->focused, FALSE);
  ASSERT_EQ(b2->focused, TRUE);

  ASSERT_EQ(widget_move_focus(b2, NULL, NULL, TRUE), RET_OK);
  ASSERT_EQ(b2->focused, FALSE);
  ASSERT_EQ(b3->focused, TRUE);

  ASSERT_EQ(widget_move_focus(b3, NULL, NULL, FALSE), RET_OK);
...
TEST(Widget, move_focus_pages) {
  ...
  ASSERT_EQ(widget_move_focus(b0, NULL, NULL, TRUE), RET_OK);
