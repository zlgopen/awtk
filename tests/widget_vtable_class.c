...
static const char* s_all_base_class_clone_properties[] = {WIDGET_PROP_VIRTUAL_W,
...
TK_DECL_VTABLE(all_base_class) = {
    .size = sizeof(all_base_class_t),
...
static ret_t base_class_on_paint_background(widget_t* widget, canvas_t* c) {
  ...
  return widget_vtable_on_paint_background_by_parent(widget, c,
                                                     WIDGET_VTABLE_GET_VTABLE(base_class));
}
...
static ret_t base_class_on_remove_child(widget_t* widget, widget_t* child) {
  ...
  return widget_vtable_on_remove_child_by_parent(widget, child,
                                                 WIDGET_VTABLE_GET_VTABLE(base_class));
}
...
static ret_t base_class_on_attach_parent(widget_t* widget, widget_t* parent) {
  ...
  return widget_vtable_on_attach_parent_by_parent(widget, parent,
                                                  WIDGET_VTABLE_GET_VTABLE(base_class));
}
...
static ret_t base_class_on_detach_parent(widget_t* widget, widget_t* parent) {
  ...
  return widget_vtable_on_detach_parent_by_parent(widget, parent,
                                                  WIDGET_VTABLE_GET_VTABLE(base_class));
}
...
static ret_t base_class_on_event_before_children(widget_t* widget, event_t* e) {
  ...
  return widget_vtable_on_event_before_children_by_parent(widget, e,
                                                          WIDGET_VTABLE_GET_VTABLE(base_class));
}
...
static const char* s_base_class_clone_properties[] = {WIDGET_PROP_NAME, WIDGET_PROP_CLOSABLE,
                                                      WIDGET_PROP_RADIO};
...
TK_DECL_VTABLE(base_class) = {
    .size = sizeof(base_class_t),
...
static ret_t sun_class_get_only_active_children(widget_t* widget, darray_t* all_focusable) {
  ...
  return widget_vtable_get_only_active_children_by_parent(widget, all_focusable,
                                                          WIDGET_VTABLE_GET_VTABLE(sun_class));
}
...
static ret_t sun_class_get_offset(widget_t* widget, xy_t* out_x, xy_t* out_y) {
  ...
  return widget_vtable_get_offset_by_parent(widget, out_x, out_y,
                                            WIDGET_VTABLE_GET_VTABLE(sun_class));
}
...
static widget_t* sun_class_find_target(widget_t* widget, xy_t x, xy_t y) {
  ...
  ret = widget_vtable_find_target_by_parent(widget, x, y, &ret_widget,
                                            WIDGET_VTABLE_GET_VTABLE(sun_class));
...
static bool_t sun_class_is_point_in(widget_t* widget, xy_t x, xy_t y) {
  ...
  ret = widget_vtable_is_point_in_by_parent(widget, x, y, &ret_is_point_in,
                                            WIDGET_VTABLE_GET_VTABLE(sun_class));
...
static ret_t sun_class_get_prop_default_value(widget_t* widget, const char* name, value_t* v) {
  ...
  return widget_vtable_get_prop_default_value_by_parent(widget, name, v,
                                                        WIDGET_VTABLE_GET_VTABLE(sun_class));
}
