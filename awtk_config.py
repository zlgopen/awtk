...
if VGCANVAS == 'CAIRO':
  ...
  if NANOVG_BACKEND == 'AGG':
    ...
    COMMON_CCFLAGS = COMMON_CCFLAGS + ' -DWITH_NANOVG_GLES2 -DWITH_GPU_GLES2 -DWITH_NANOVG_GL -DWITH_NANOVG_GPU  '
  elif NANOVG_BACKEND == 'GLES3':
    NANOVG_BACKEND_LIBS=['nanovg'];
    COMMON_CCFLAGS = COMMON_CCFLAGS + ' -DWITH_NANOVG_GLES3 -DWITH_NANOVG_GL -DWITH_NANOVG_GPU  '
  else:
    NANOVG_BACKEND_LIBS=['nanovg'];
    COMMON_CCFLAGS = COMMON_CCFLAGS + ' -DWITH_NANOVG_GL3 -DWITH_NANOVG_GL -DWITH_NANOVG_GPU  '
