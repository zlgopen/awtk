...
AWTK_STATIC_LIBS=['awtk_global', 'extwidgets', 'widgets', 'base', 'gpinyin', 'streams', 'conf_io', 'csv', 'ubjson', 'compressors', 'fribidi', 'miniz', 'tkc_static', 'linebreak']
...
if OS_NAME == 'Darwin':
  ...
  OS_WHOLE_ARCHIVE =' -Wl,--whole-archive -lawtk_global -lextwidgets -lwidgets -lbase -lgpinyin -lstreams -lconf_io -lcsv -lubjson -lcompressors -lfribidi -lminiz -ltkc_static -llinebreak -Wl,--no-whole-archive'
