...
set(AWTK_SHEENBIDI_INCLUDES
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Headers
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source
)
...
set(AWTK_COMMON_FLAGS "${AWTK_COMMON_FLAGS} -DWITH_BIDI_SHEEN=1 -DSB_CONFIG_EXPERIMENTAL_TEXT_API=1 ")

set(AWTK_HARFBUZZ_FLAGS " -DWITH_HARFBUZZ_TEXT_SHAPING -DHAVE_CONFIG_H ")
...
file(GLOB AWTK_BASE_SOURCE_FILES 
  ...
  ${AWTK_SRC_PATH}/font_loader/harfbuzz/*.c
  ${AWTK_SRC_PATH}/font_loader/harfbuzz/*.cpp
...
file(GLOB AWTK_HARFBUZZ_SOURCE_FILES
  ${AWTK_3RD_PATH}/harfbuzz/harfbuzz.cc
)
...
file(GLOB AWTK_SHEENBIDI_SOURCE_FILES
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/API/*.c
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/Core/*.c
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/Data/*.c
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/Script/*.c
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/Text/*.c
  ${AWTK_3RD_PATH}/SheenBidi-3.0.0/Source/UBA/*.c
)
