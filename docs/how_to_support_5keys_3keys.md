...
首先修改 AWTK 中的 [awtk_config.py](https://github.com/zlgopen/awtk/blob/master/awtk_config.py#L102) 文件，定义宏 `WITH_STATE_ACTIVATED`，重新编译 AWTK。
...
- [demo_5key_app](https://github.com/zlgopen/awtk/blob/master/demos/demo_5key_app.c)

## 其他

如果希望在激活时，控件呈现不同的外观效果，请在 style 文件中编写 activated 状态的参数。如：
