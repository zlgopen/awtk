...
| <a href="#row_t_row_get_widget_vtable">row\_get\_widget\_vtable</a> | 获取 row 虚表。 |
#### row\_cast 函数
-----------------------
...
| w | wh\_t | 宽度 |
| h | wh\_t | 高度 |
#### row\_get\_widget\_vtable 函数
-----------------------

* 函数功能：

> <p id="row_t_row_get_widget_vtable">获取 row 虚表。
...
| 参数 | 类型 | 说明 |
| -------- | ----- | --------- |
| 返回值 | const widget\_vtable\_t* | 成功返回 row 虚表。 |
