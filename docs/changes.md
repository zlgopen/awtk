...
* 2019/12/04
  ...
  * awtk增加图标所在的位置支持垂直水平居中功能 （感谢智明提供补丁）。  
  * 完善增加了scroll_view控件可以调节控件自动播放的速度比例接口 （感谢智明提供补丁）。  
  * 完善tk\_mem\_stat (感謝王程提供补丁）。  
  * 完善assset_manager关于自定义路径的处理（感谢大恒提供补丁）。
  * 完善scroll view的注释（感谢大恒提供补丁）。
