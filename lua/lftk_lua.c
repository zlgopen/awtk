...
static int wrap_button_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  ...
  luaL_getmetatable(L, "lftk.button_t");
...
static int wrap_button_t_set_prop(lua_State* L) {
  button_t* obj = (button_t*)lftk_checkudata(L, 1, "lftk.button_t");
...
static int wrap_check_button_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.check_button_t");
  lua_setmetatable(L, -2);
...
static int wrap_check_button_t_set_prop(lua_State* L) {
  check_button_t* obj = (check_button_t*)lftk_checkudata(L, 1, "lftk.check_button_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
...
static int wrap_dialog_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.dialog_t");
  lua_setmetatable(L, -2);
...
static int wrap_dialog_t_set_prop(lua_State* L) {
  dialog_t* obj = (dialog_t*)lftk_checkudata(L, 1, "lftk.dialog_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  return wrap_widget_t_set_prop(L);
...
static int wrap_event_t_set_prop(lua_State* L) {
  event_t* obj = (event_t*)lftk_checkudata(L, 1, "lftk.event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
...
static int wrap_pointer_event_cast(lua_State* L) {
  ...
  event_t* event = (event_t*)lftk_checkudata(L, 1, "lftk.event_t");
  ret = (pointer_event_t*)pointer_event_cast(event);

  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.pointer_event_t");
  lua_setmetatable(L, -2);
...
static int wrap_pointer_event_t_set_prop(lua_State* L) {
  pointer_event_t* obj = (pointer_event_t*)lftk_checkudata(L, 1, "lftk.pointer_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "x") == 0) {
...
static int wrap_key_event_cast(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.key_event_t");
  lua_setmetatable(L, -2);
...
static int wrap_key_event_t_set_prop(lua_State* L) {
  key_event_t* obj = (key_event_t*)lftk_checkudata(L, 1, "lftk.key_event_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
...
static int wrap_group_box_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.group_box_t");
  lua_setmetatable(L, -2);
...
static int wrap_group_box_t_set_prop(lua_State* L) {
  group_box_t* obj = (group_box_t*)lftk_checkudata(L, 1, "lftk.group_box_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  return wrap_widget_t_set_prop(L);
...
static int wrap_image_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.image_t");
  lua_setmetatable(L, -2);
...
static int wrap_image_t_set_prop(lua_State* L) {
  image_t* obj = (image_t*)lftk_checkudata(L, 1, "lftk.image_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  return wrap_widget_t_set_prop(L);
...
static int wrap_label_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.label_t");
  lua_setmetatable(L, -2);
...
static int wrap_label_t_set_prop(lua_State* L) {
  label_t* obj = (label_t*)lftk_checkudata(L, 1, "lftk.label_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
...
static int wrap_progress_bar_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.progress_bar_t");
  lua_setmetatable(L, -2);
...
static int wrap_progress_bar_t_set_prop(lua_State* L) {
  progress_bar_t* obj = (progress_bar_t*)lftk_checkudata(L, 1, "lftk.progress_bar_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "value") == 0) {
...
static int wrap_point_t_set_prop(lua_State* L) {
  point_t* obj = (point_t*)lftk_checkudata(L, 1, "lftk.point_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "x") == 0) {
...
static int wrap_rect_t_set_prop(lua_State* L) {
  rect_t* obj = (rect_t*)lftk_checkudata(L, 1, "lftk.rect_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "x") == 0) {
...
static int wrap_style_t_set_prop(lua_State* L) {
  style_t* obj = (style_t*)lftk_checkudata(L, 1, "lftk.style_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  printf("%s: not supported %s\n", __func__, name);
...
static int wrap_theme_t_set_prop(lua_State* L) {
  theme_t* obj = (theme_t*)lftk_checkudata(L, 1, "lftk.theme_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  printf("%s: not supported %s\n", __func__, name);
...
static void style_type_t_init(lua_State* L) {
  lua_newtable(L);
...
static int wrap_value_set_bool(lua_State* L) {
  value_t* ret = NULL;
  value_t* v = (value_t*)lftk_checkudata(L, 1, "lftk.value_t");
...
static int wrap_value_is_null(lua_State* L) {
  bool_t ret = 0;
  value_t* value = (value_t*)lftk_checkudata(L, 1, "lftk.value_t");
...
static int wrap_value_copy(lua_State* L) {
  value_t* dst = (value_t*)lftk_checkudata(L, 1, "lftk.value_t");
  value_t* src = (value_t*)lftk_checkudata(L, 2, "lftk.value_t");
...
static int wrap_value_t_set_prop(lua_State* L) {
  value_t* obj = (value_t*)lftk_checkudata(L, 1, "lftk.value_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "type") == 0) {
...
static int wrap_widget_to_local(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  point_t* p = (point_t*)lftk_checkudata(L, 2, "lftk.point_t");
...
static int wrap_widget_add_child(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  widget_t* child = (widget_t*)lftk_checkudata(L, 2, "lftk.widget_t");
...
static int wrap_widget_invalidate(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  rect_t* r = (rect_t*)lftk_checkudata(L, 2, "lftk.rect_t");
...
static int wrap_widget_get_prop(lua_State* L) {
  ...
  widget_t* widget = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  char* name = (char*)luaL_checkstring(L, 2);
  value_t* v = (value_t*)lftk_checkudata(L, 3, "lftk.value_t");
...
static int wrap_widget_t_set_prop(lua_State* L) {
  widget_t* obj = (widget_t*)lftk_checkudata(L, 1, "lftk.widget_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  if(strcmp(name, "x") == 0) {
...
static int wrap_widget_t_get_prop(lua_State* L) {
  ...
  if(strcmp(name, "x") == 0) {
    ...
    lua_pushlightuserdata(L,(void*)(obj->parent));
    return 1;
  }
  else {
    printf("%s: not supported %s\n", __func__, name);
...
static int wrap_window_manager_t_set_prop(lua_State* L) {
  window_manager_t* obj = (window_manager_t*)lftk_checkudata(L, 1, "lftk.window_manager_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  return wrap_widget_t_set_prop(L);
...
static int wrap_window_create(lua_State* L) {
  ...
  lua_pushlightuserdata(L,(void*)(ret));
  luaL_getmetatable(L, "lftk.window_t");
  lua_setmetatable(L, -2);
...
static int wrap_window_t_set_prop(lua_State* L) {
  window_t* obj = (window_t*)lftk_checkudata(L, 1, "lftk.window_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
(void)obj;
(void)name;
  return wrap_widget_t_set_prop(L);
