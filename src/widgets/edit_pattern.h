...
typedef wchar_t* (*pattern_part_fix_ctx_t)(uint32_t index, int32_t value, wchar_t* start,
                                           wchar_t* end, void* ctx);
...
static wchar_t* edit_pattern_fix_adapter(uint32_t index, int32_t value, wchar_t* start,
                                         wchar_t* end, void* ctx) {
