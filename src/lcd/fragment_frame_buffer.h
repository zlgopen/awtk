...
static fragment_frame_buffer_t* fragment_frame_buffer_init(fragment_frame_buffer_t* ffb, pixel_t* data, uint32_t pixels_nr) {
...
static fragment_frame_buffer_t* fragment_frame_buffer_begin_frame(fragment_frame_buffer_t* ffb, rect_t* r) {
  uint32_t nr = 0;
...
static inline ret_t fragment_frame_buffer_set_pixel(fragment_frame_buffer_t* ffb, 
...
static inline pixel_t fragment_frame_buffer_get_pixel(fragment_frame_buffer_t* ffb, 
...
static inline ret_t fragment_frame_buffer_set_window(fragment_frame_buffer_t* ffb, 
