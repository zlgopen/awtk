...
/**
 * @method lcd_mem_bgra8888_create_single_fb_bitmap
 *
 * 创建single fb lcd对象。
 *
...
/**
 * @method lcd_mem_bgra8888_create_double_fb_bitmap
 *
 * 创建double fb lcd对象。
 *
 ...
 * @return {lcd_t*} 返回lcd对象。
 */
lcd_t* lcd_mem_bgra8888_create_double_fb_bitmap(bitmap_t* online_fb_bitmap,
                                                bitmap_t* offline_fb_bitmap);

/**
 * @method lcd_mem_bgra8888_create_three_fb_bitmap
 * 
 * 创建three fb lcd对象。
 *
 * @param {bitmap_t*} online_fb_bitmap 在线帧率缓冲区。
 ...
 * @return {lcd_t*} 返回lcd对象。
 */
lcd_t* lcd_mem_bgra8888_create_three_fb_bitmap(bitmap_t* online_fb_bitmap,
                                               bitmap_t* offline_fb_bitmap,
