...
ret_t ubjson_writer_write_float32(ubjson_writer_t* writer, float value) {                                                                                
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_FLOAT32) == RET_OK, RET_OOM);                                                    
...
ret_t ubjson_writer_write_float64(ubjson_writer_t* writer, double value) {                                                                               
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_FLOAT64) == RET_OK, RET_OOM);                                                    
  value = float_to_big_endian(value);                                                                                                                  
  return_value_if_fail(ubjson_writer_write_data(writer, &value, sizeof(value)) == RET_OK, RET_OOM);                                                      
...
ret_t ubjson_writer_write_array_begin(ubjson_writer_t* writer) {                                                                                         
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_ARRAY_BEGIN) == RET_OK, RET_OOM);                                                
...
ret_t ubjson_writer_write_array_end(ubjson_writer_t* writer) {                                                                                           
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_ARRAY_END) == RET_OK, RET_OOM);                                                  
...
ret_t ubjson_writer_write_object_begin(ubjson_writer_t* writer) {                                                                                        
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_OBJECT_BEGIN) == RET_OK, RET_OOM);                                               
...
ret_t ubjson_writer_write_object_end(ubjson_writer_t* writer) {                                                                                          
  return_value_if_fail(writer != NULL, RET_BAD_PARAMS);                                                                                                  
  return_value_if_fail(ubjson_writer_write_marker(writer, UBJSON_MARKER_OBJECT_END) == RET_OK, RET_OOM);                                                 
