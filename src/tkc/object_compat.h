...
#define OBJECT_LIFE_NONE TK_OBJECT_LIFE_NONE
#define OBJECT_LIFE_OWN TK_OBJECT_LIFE_OWN
#define OBJECT_LIFE_HOLD TK_OBJECT_LIFE_HOLD
#define OBJECT_CMD_EXEC TK_OBJECT_CMD_EXEC
#define OBJECT_CMD_UNDO TK_OBJECT_CMD_UNDO
#define OBJECT_PROP_DISABLE_PATH TK_OBJECT_PROP_DISABLE_PATH
#define OBJECT_PROP_KEEP_PROPS_ORDER TK_OBJECT_PROP_KEEP_PROPS_ORDER
