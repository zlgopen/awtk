...
#define MIME_TYPE_APPLICATION_X_TROFF-MAN "application/x-troff-man"
#define MIME_TYPE_APPLICATION_X_TROFF-ME "application/x-troff-me"
#define MIME_TYPE_APPLICATION_X_TROFF-MS "application/x-troff-ms"
...
#define MIME_TYPE_IMAGE_SVG+XML "image/svg+xml"
#define MIME_TYPE_IMAGE_TIFF "image/tiff"
#define MIME_TYPE_IMAGE_X_CMU-RASTER "image/x-cmu-raster"
