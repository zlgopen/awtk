...
/**
 * @method object_hash_clone
 *
 * 克隆对象。
 *
 * @annotation ["constructor"]
 * @param {object_hash_t*} o 被克隆的对象。
 *
 * @return {tk_object_t*} 返回object对象。
 *
 */
...
/**
 * @method object_hash_clear_props
 *
 * 清除全部属性。
 *
 * @annotation ["scriptable"]
 ...
 *
 */
value_t* object_hash_find_prop(tk_object_t* obj, tk_compare_t cmp, const void* data);
