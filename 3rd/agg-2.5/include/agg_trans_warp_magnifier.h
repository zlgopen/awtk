...
namespace agg
{
    ...
    public:
        ...
        void center(float_t x, float_t y) { m_xc = x; m_yc = y; }
        void magnification(float_t m)    { m_magn = m;         }
        void radius(float_t r)           { m_radius = r;       }

        float_t xc()            const { return m_xc; }
        float_t yc()            const { return m_yc; }
        float_t magnification() const { return m_magn;   }
