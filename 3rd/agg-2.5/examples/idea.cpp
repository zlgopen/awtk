...
static float_t g_poly_beam1[] = 
{
    -14,-84,-22,-85,-23,-87,-22,-88,-21,-88
};

static float_t g_poly_beam2[] = 
{
   -10,-92,   -14,-96,   -14,-98,   -12,-99,   -11,-97
};

static float_t g_poly_beam3[] = 
{
   -1,-92,     -2,-98,    0,-100,    2,-100,    1,-98
};

static float_t g_poly_beam4[] = 
{
    5,-89,      11,-94,   13,-93,    13,-92,    12,-91
};


static float_t g_poly_fig1[] = 
{
...
{
    static void transform(float_t* x, float_t* y)
    {
        *x = floor(*x + 0.5);
        *y = floor(*y + 0.5);
    }
