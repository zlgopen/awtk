...
namespace agg
{
    ...
    polygon_ctrl_impl::polygon_ctrl_impl(unsigned np, float_t point_radius) :
        ctrl(0, 0, 1, 1, false),
        m_polygon(np * 2),
        m_num_points(np),
        m_node(-1),
    ...
    unsigned polygon_ctrl_impl::vertex(float_t* x, float_t* y)
    {
    ...
    bool polygon_ctrl_impl::check_edge(unsigned i, float_t x, float_t y) const
    {
       bool ret = false;
    ...
    bool polygon_ctrl_impl::in_rect(float_t x, float_t y) const
    {
        return false;
    }


    bool polygon_ctrl_impl::on_mouse_button_down(float_t x, float_t y)
    {
        unsigned i;
        bool ret = false;
        m_node = -1;
    ...
    bool polygon_ctrl_impl::on_mouse_move(float_t x, float_t y, bool button_flag)
    {
        bool ret = false;
        float_t dx;
        float_t dy;
    ...
    bool polygon_ctrl_impl::on_mouse_button_up(float_t x, float_t y)
    {
    ...
    bool polygon_ctrl_impl::point_in_polygon(float_t tx, float_t ty) const
    {
