...
AWKT_FONT_IMAGE_FILES=glob.glob(AWTK_SRC_DIR+'/image_loader/*.c')
...
LINT_FILES=COMMON_FILES + AWKT_FONT_LOADER_FILES + AWKT_FONT_IMAGE_FILES 

INFER_FILES=LINT_FILES
CPPCHECK_FILES=LINT_FILES + AWKT_XML_FILES
